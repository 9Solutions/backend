...
public class ProdutoServiceDesabilitandoProdutoTest {
    ...
    @Test
    @DisplayName("Deve desabilitar um produto")
    void testDesabilitaUmProduto() {
        Produto produto = new Produto();
        produto.setId(1);
        when(produtoRepository.findById(1)).thenReturn(Optional.of(produto));

        ResponseEntity<Void> response = produtoService.disableItem(1);
