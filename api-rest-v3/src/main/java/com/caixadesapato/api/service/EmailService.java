...
public class    EmailService {
    ...
    public void sendMail(String destinatario, String assunto, MultipartFile file, String nomeDoador) {
        String imageCid = "imageSrc";


        String mensagemEntrega = "<!DOCTYPE html>\n" +
            "<html lang=\"pt-BR\">\n" +
            "<head>\n" +
            "   <meta charset=\"UTF-8\">\n" +
            ...
            "\n" +
            "           <center>\n" +
            "               <img src=\"cid:imageSrc\" style=\"width: 90%;\"/>\n" +
            "           </center>\n" +
            "\n" +
        ...
        String mensagemAtualizacaoStatus = "<!DOCTYPE html>\n" +
                "<html lang=\"pt-BR\">\n" +
                "<head>\n" +
                "   <meta charset=\"UTF-8\">\n" +
                "   <meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0\">\n" +
                ...
                "           <p>Bem-vindo ao nosso serviço de entregas de caixas por todo o Brasil! Estamos muito felizes em tê-lo conosco.</p>\n" +
                "\n" +
                "           <p>O Status da sua doação foi alterado\n" +
                "\n" +
                "           <p>Se precisar de ajuda, entre em contato conosco respondendo a este e-mail.</p>\n" +
                "\n" +
                "           <p><br>Atenciosamente,<br>\n" +
        ...
        try {
            ...
            if (file != null && !file.isEmpty()) {
                ...
                preparator = mimeMessage -> {
                    ...
                    helper.setTo(destinatario);
                    helper.setSubject(assunto);
                    helper.setText(mensagemAtualizacaoStatus, true);
                };
            }
